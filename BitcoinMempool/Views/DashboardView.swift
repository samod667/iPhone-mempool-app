...
// Dashboard view as a separate struct
struct DashboardView: View {
    ...
    private var feesSection: some View {
        VStack(spacing: 10) {
            ...
            // Main fee container
            VStack(spacing: 0) {
                // Priority categories bar with more consistent styling
                HStack(spacing: 0) {
                    Text("Low Priority")
                        .font(.system(size: 14))
                        .foregroundColor(.white)
                        ...
                        .background(Color(red: 0.45, green: 0.55, blue: 0.15).opacity(0.8))
                    ...
                    Text("Medium Priority")
                        ...
                        .padding(.vertical, 6)
                        .frame(maxWidth: .infinity)
                        .background(Color(red: 0.55, green: 0.55, blue: 0.15).opacity(0.8))
                    ...
                    Text("High Priority")
                        ...
                        .padding(.vertical, 6)
                        .frame(maxWidth: .infinity)
                        .background(Color(red: 0.55, green: 0.45, blue: 0.15).opacity(0.8))
                }
                .background(Color.mempoolBackground.opacity(0.3))
                
                // Fee rates row - Removed black background, using consistent styling
                HStack(spacing: 0) {
                    // Low Priority
                    VStack(spacing: 2) {
...
// Stat card component - kept outside the DashboardView struct
